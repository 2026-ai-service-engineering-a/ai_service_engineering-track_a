...
시연 전후로 코드를 직접 읽을 때의 가이드입니다. 시작점은
[v0.1 태그](https://github.com/2026-ai-service-engineering-a/week01-order-agent/tree/v0.1),
지시 프롬프트(PROMPT.md)를 실행해 완성한 참고 구현은
[v0.2 태그](https://github.com/2026-ai-service-engineering-a/week01-order-agent/tree/v0.2)로
발행되어 있습니다. 두 태그의 차이가 곧 "에이전트를 붙이며 생긴 것"의 전부입니다.
...
- 웹 화면이 채팅처럼 보여도 서버는 이전 주문을 기억하지 못합니다 —
  주문은 **한 문장에** 다 담아야 합니다
- 결함이 아니라 1주차의 의도된 범위입니다 — 대화 메모리는 컨텍스트
  엔지니어링(사다리 2단)의 주제이고, 이후 주차에서 다룹니다
