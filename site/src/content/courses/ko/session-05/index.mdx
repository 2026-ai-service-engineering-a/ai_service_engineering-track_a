...
description: "5주차 라이브 세션 상세 교안: 실습 랩 기동, examples/01_api 11종으로 LLM API의 바닥, examples/02_litellm 10종으로 통합 레이어, examples/03_tools 10종으로 tool calling 심화, 그리고 에이전트가 처음으로 도구를 드는 지점까지"
...
category: foundation
slides: ["session-05"]
tags: ["LLM API", "토큰", "무상태", "LiteLLM", "폴백", "tool calling", "Pydantic", "구조화 출력"]
level: 2
order: "05"
---
...
### 5-13. 코드 포인트: 예산 계산 도구가 스키마로 실리는 지점
