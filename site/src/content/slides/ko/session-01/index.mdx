...
저장소: `2026-ai-service-engineering-a/week01-order-agent` (template repository)
...
## 저장소 구조 (v1.0)
::sub[v0.1은 app/ + data/ + 설정뿐 — 화살표 부분이 라이브에서 생성됩니다]
