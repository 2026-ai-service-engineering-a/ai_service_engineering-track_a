...
description: "5주차 라이브 세션 슬라이드: AI 모델과 AI 서비스의 구분과 도구의 정의, examples/01_api 11종으로 LLM API의 바닥, examples/02_litellm 10종으로 통합 레이어, examples/03_tools 10종으로 tool calling 심화, 그리고 에이전트가 처음으로 도구를 드는 지점까지"
...
- 예제 **31종을 전부 실행**하고, 끝에서 에이전트가 **처음으로 도구를 듭니다**
