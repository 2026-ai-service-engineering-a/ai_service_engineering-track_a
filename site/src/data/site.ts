...
export const site = {
  ...
  home: {
    ...
    hero: {
      ...
      subtitle:
        '공통 기술 스택 실습(1~9회차)으로 기초를 정렬하고,<br>개인별 배포 가능한 오픈소스 기반 AI 데모 서비스(10~14회차)를 완성하는 14회차 실습 트랙.',
    },
    cardsTitle: '바로가기',
    cards: [
      {
        href: '/course/',
        name: '강의',
        description: '회차별 강의 자료와 실습 가이드 —<br>환경 구축부터 RAG, FastAPI, 배포까지.',
        tags: ['1~9회차 공통 기반', '10~14회차 개인 프로젝트'],
      },
      {
        href: '/slides/',
        name: '슬라이드',
        description: '회차별 강의 슬라이드 —<br>브라우저에서 바로 보는 프레젠테이션.',
        tags: ['프레젠테이션'],
      },
      {
        href: '/concept/',
  ...
  ui: {
    ko: {
      'site.tagline':
        'AI 서비스 엔지니어링 Track A — 14회차 실습 트랙의 강의 자료, 슬라이드, 개념 정리, 용어집.',
    },
